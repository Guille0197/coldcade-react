...
const Contenedores = () => {
  ...
  const header = (
    <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
      <h5 className="m-0">Administrar Contenedores</h5>
...
export default React.memo(Contenedores);
